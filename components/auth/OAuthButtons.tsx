...
export default function OAuthButtons({ mode = "signin", className = "" }: OAuthButtonsProps) {
  ...
  const handleOAuthSignIn = async (provider: "google" | "github") => {
    ...
    try {
      ...
      // Construct the callback URL with next parameter preserved
      ...
      toast({
        title: `Redirecting to ${provider === "google" ? "Google" : "GitHub"}...`,
      ...
      if (error.message?.includes("popup")) {
        setError("Pop-ups are blocked. Please allow pop-ups or use the standard email sign-in below.")
